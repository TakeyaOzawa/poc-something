...
describe('Website Entity', () => {
  ...
  describe('constructor', () => {
    it('should create a Website with valid data', () => {
      ...
      expect(website.getIdValue()).toBe('website_001');
  ...
  describe('setStartUrl', () => {
    it('should update start URL', () => {
      ...
      expect(updated.getStartUrlValue()).toBe('https://new-url.com/');
      expect(website.getStartUrlValue()).toBe('https://example.com/');
    });
  });
  ...
  describe('create static factory', () => {
    it(
      ...
      () => {
        ...
        expect(website.getIdValue()).toMatch(/^[a-z0-9_]+$/);
        expect(website.getName()).toBe('New Website');
        expect(website.isEditable()).toBe(true);
        expect(website.getStartUrlValue()).toBeUndefined();
      },
      mockIdGenerator
    );
    ...
    it(
      ...
      () => {
        ...
        expect(website.getStartUrlValue()).toBe('https://test.com/');
      },
      mockIdGenerator
    );
