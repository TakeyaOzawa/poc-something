...
describe('SyncResult Entity', () => {
  ...
  describe('create static factory', () => {
    it('should create receive success result with minimal params', () => {
      ...
      expect(result.getId()).toBe('test-uuid-1234-5678-90ab-cdef12345678');
    ...
    it('should create send success result', () => {
      const result = SyncResult.create({
    ...
    it('should generate current timestamp for syncedAt', () => {
    ...
    it('should include all optional count fields', () => {
      const result = SyncResult.create({
    ...
    it('should handle itemsSent for send operations', () => {
      const result = SyncResult.create({
  ...
  describe('edge cases', () => {
    ...
    it('should handle all count fields set to maximum values', () => {
      const result = SyncResult.create({
  ...
  describe('real-world scenarios', () => {
    it('should represent successful bidirectional sync - receive phase', () => {
      const result = SyncResult.create({
    ...
    it('should represent successful bidirectional sync - send phase', () => {
      const result = SyncResult.create({
        syncConfigId: 'config-bidirectional',
        storageKey: 'automationVariables',
        direction: 'send',
    ...
    it('should represent failed sync with detailed error', () => {
      const result = SyncResult.create({
    ...
    it('should represent CSV import result', () => {
      const result = SyncResult.create({
    ...
    it('should represent CSV export result', () => {
      const result = SyncResult.create({
        syncConfigId: 'config-csv',
        storageKey: 'automationResults',
        direction: 'send',
