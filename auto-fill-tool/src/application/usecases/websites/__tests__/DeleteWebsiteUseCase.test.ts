...
describe('DeleteWebsiteUseCase', () => {
  ...
  it(
    'should delete website and associated xpaths',
    async () => {
  ...
  it(
    'should delete automation variables even when no xpaths exist',
    async () => {
      const website = Website.create({ name: 'Test Website' });
      const websiteCollection = new WebsiteCollection([website]);
  ...
  it(
    'should throw error when automation variables deletion fails',
    async () => {
      const website = Website.create({ name: 'Test Website' });
      const websiteCollection = new WebsiteCollection([website]);
  ...
  it('should return failure when website repository load fails', async () => {
    ...
    const output = await useCase.execute({ websiteId: 'test-website-id' }, mockIdGenerator);
  ...
  it(
    'should return failure when website repository save fails',
    async () => {
      const website = Website.create({ name: 'Test Website' });
      const websiteCollection = new WebsiteCollection([website]);
  ...
  it(
    'should return failure when xpath repository load fails',
    async () => {
      const website = Website.create({ name: 'Test Website' });
      const websiteCollection = new WebsiteCollection([website]);
  ...
  it(
    'should return failure when xpath repository save fails',
    async () => {
      const website = Website.create({ name: 'Test Website' });
      const websiteCollection = new WebsiteCollection([website]);
