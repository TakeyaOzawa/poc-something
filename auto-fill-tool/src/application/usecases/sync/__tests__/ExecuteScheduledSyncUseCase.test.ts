...
describe(
  ...
  () => {
    ...
    describe(
      'scheduleAllPeriodicSyncs',
      () => {
        it(
          'should schedule all enabled periodic sync configurations',
          async () => {
            ...
            mockRepository.loadAllEnabledPeriodic.mockResolvedValue(
              Result.success([config1, config2])
            );
            mockScheduler.scheduleRepeating.mockResolvedValue();

            const result = await useCase.scheduleAllPeriodicSyncs({}, mockIdGenerator);
        ...
        it(
          'should return success with zero count when no configs found',
          async () => {
        ...
        it(
          'should skip already scheduled configs',
          async () => {
            ...
            await useCase.scheduleAllPeriodicSyncs({}, mockIdGenerator);
        ...
        it(
          'should handle exceptions during scheduled sync execution',
          async () => {
            const config = StorageSyncConfig.create(
              {
                storageKey: 'data1',
            ...
            let scheduledCallback: (() => void | Promise<void>) | null = null;
            mockScheduler.scheduleRepeating.mockImplementation(
              async (_name, _interval, callback) => {
                scheduledCallback = callback;
              },
              mockIdGenerator
            );
    ...
    describe('stopAllScheduledSyncs', () => {
      it(
        'should stop all scheduled syncs',
        async () => {
          const config = StorageSyncConfig.create(
            {
              storageKey: 'data1',
          ...
          const result = await useCase.stopAllScheduledSyncs({}, mockIdGenerator);
      ...
      it(
        'should handle errors when stopping scheduled syncs',
        async () => {
    ...
    describe(
      ...
      () => {
        it(
          'should stop a specific scheduled sync',
          async () => {
            const config = StorageSyncConfig.create(
              {
                storageKey: 'data1',
        ...
        it(
          'should handle errors when stopping a specific scheduled sync',
          async () => {
            const config = StorageSyncConfig.create(
              {
                storageKey: 'data1',
    ...
    describe(
      ...
      () => {
        ...
        it(
          'should return correct count after scheduling',
          async () => {
            const config1 = StorageSyncConfig.create(
              {
                storageKey: 'data1',
    ...
    describe(
      ...
      () => {
        it(
          'should return false for non-scheduled config',
          () => {
        ...
        it(
          'should return true for scheduled config',
          async () => {
            const config = StorageSyncConfig.create(
              {
                storageKey: 'data1',
