...
HOOKS_DIR="scripts/coding-helpers"
HOOKS=(
    "quality-gate.sh"
    "coverage-check.sh"
...
echo "./scripts/coding-helpers/quality-gate.sh"
echo "\`\`\`"
echo ""
...
echo "# Claude"
echo "cd auto-fill-tool"
echo "./scripts/coding-helpers/coverage-check.sh"
echo "\`\`\`"
echo ""
...
echo ""
echo "**🎯 推奨使用方法**:"
echo "- 開発完了時: \`./scripts/coding-helpers/quality-gate.sh\`"
echo "- コミット前: \`./scripts/coding-helpers/pre-commit-review.sh\`"
echo "- カバレッジ不足時: \`./scripts/coding-helpers/coverage-check.sh\`"
echo ""
